...
const PaymentMethods = () => {
  const {
    data: { currentList, currentIdentityName, currentIdentityType, openModal, stripeAccounts, ConnectButton },
    operations: { setOpenModal, handleCloseModal, onRemoveCard },
  } = usePaymentMethods();
  ...
  return (
    <>
      ...
      />
      <AddPayoutAccount open={openModal.name === 'add-account' && openModal.open} handleClose={handleCloseModal} />
    </>
  );
};
